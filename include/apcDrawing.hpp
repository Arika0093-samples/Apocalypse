...
namespace Apocalypse
{
	namespace Draw
	{
		...
		public:
			...
			/// </summary>
			/// <remarks>
			///		<para>trueに指定するとフレームの外側に描画を行わなくなります．</para>
			///		<para>標準ではtrueです．</para>
			/// </remarks>
			bool					DrawFramework;
			/// <summary>
			///		このフレームの基準位置からの座標．
		...
		public:
			...
			public:
				...
				{
					///	<summary>
					///		特に変化を加えずフレームの左上に描画する．
					///	</summary>
					TopLeft,
					///	<summary>
					///		特に変化を加えずフレームの中央上に描画する．
					///	</summary>
					TopCenter,
					///	<summary>
					///		特に変化を加えずフレームの右上に描画する．
					///	</summary>
					TopRight,
					///	<summary>
					///		特に変化を加えずフレームの左中央に描画する．
					///	</summary>
					MiddleLeft,
					///	<summary>
					///		特に変化を加えずフレームの中心に描画する．
					///	</summary>
					MiddleCenter,
					///	<summary>
					///		特に変化を加えずフレームの右中央に描画する．
					///	</summary>
					MiddleRight,
					///	<summary>
					///		特に変化を加えずフレームの左下に描画する．
					///	</summary>
					BottomLeft,
					///	<summary>
					///		特に変化を加えずフレームの中央下に描画する．
					///	</summary>
					BottomCenter,
					///	<summary>
					///		特に変化を加えずフレームの右下に描画する．
					///	</summary>
					BottomRight,
					///	<summary>
					///		フレームの縦横幅いっぱいに拡大して描画する
					///	</summary>
					Stretch,
					///	<summary>
					///		フレーム内に収まるよう中心拡大して描画する．Stretchと違い，画像の比率はそのまま描画する．
					///	</summary>
					Zoom,
					///	<summary>
					///		標準の描画モード．
		...
		public:
			...
			public:
				...
				enum				_Type
				{
					...
					None,
					///	<summary>
					///		文字列がフレーム内からはみ出しそうになったら一行に収まるように描画する．
					///		はみ出さない場合はそのまま描画する．
					///	</summary>
					Pack,
					///	<summary>
			...
			///	<summary>
			///		文字列の描画の種類をTextFrame::TextShowTypeから設定します．
			///	</summary>
			TextShowType::_Type		ShowType;
			///	<summary>
